...
<body>
  ...
  <div class="header position-relative w-100">
    <div class="img-wrapper w-100">
      <img src="<?php echo e(asset('assets/img/coverlp.jpg')); ?>" alt="Dentist Trans" class="img-fluid w-100 h-100">
    </div>
    <div class="position-absolute top-50 start-50 translate-middle text-center text-white">
      ...
      <button value="Masuk" class="btn bg-2 w-50" onclick="window.location='<?php echo e(url("/login")); ?>'">Masuk</button>
    </div>
  </div>
  ...
  <div class="container-card mt-5 ">
    <div class="card-content d-flex flex-wrap flex-lg-nowrap gap-3 justify-content-between w-90 m-auto">
      <div class="card w-70 m-auto">
        <img src="<?php echo e(asset('assets/img/card.png')); ?>" alt="" srcset="">
      </div>
      <div class="card w-70 m-auto">
        <img src="<?php echo e(asset('assets/img/card2.png')); ?>" alt="" srcset="">
      </div>
      <div class="card w-70 m-auto">
        <img src="<?php echo e(asset('assets/img/card3.png')); ?>" alt="" srcset="">
      </div>
    </div>
  </div>
  ...
  <div class="container-text d-flex flex-row justify-content-between w-90 m-auto mt-5 pb-5">
    ...
    <div class="text-image">
      <img src="<?php echo e(asset('assets/img/content1.png')); ?>" alt="" class="w-80">
    </div>
  </div>
  ...
  <div class="container-testi">
    ...
    <div class="content-testi d-flex">
      <div class="card-testi w-50 d-none d-lg-block">
        <img src="<?php echo e(asset('assets/img/home-testi.png')); ?>" alt="" class="w-80 h-auto">
      </div>
      <div class="container-slider">
        <div class="card-slider">
          <div class="card border-0">
            <img src="<?php echo e(asset('assets/img/testi-2.png')); ?>" alt="" class="w-25 m-auto">
            <div class="card-body">
...
</html><?php /**PATH C:\xampp\htdocs\LARAVEL\tens-dentist\resources\views/layouts/home.blade.php ENDPATH**/ ?>