        ...
        <div class="body-dashboard bg-1 rounded position-relative d-flex justify-content-between">
            ...
            <div class="element-dashboard d-flex justify-content-evenly w-50 position-absolute mt-5">
                <div class="card-element bg-body-secondary rounded shadow d-flex flex-column justify-content-between">
                    ...
                    <div class="footer-element w-100"><img class="w-100" src="<?php echo e(asset('assets/img/wave-dokter.png')); ?>"
                            alt=""></div>
                </div>
...
<?php echo $__env->make('include.sidebar_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LARAVEL\tens-dentist\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>