...
<body>
  <div class="container-panduan min-vh-100 d-flex justify-content-center position-relative">
    <div class="box-panduan-pretest z-0 w-100">
      ...
      <div class="bg-panduan-pretest bg-primary w-100 h-100">
        <img class="w-100 object-fit-cover" src="<?php echo e(asset('assets/img/Internet-Website-PNG-Photos.png')); ?>" alt="">
      </div>
    </div>
      ...
      <div class="title-panduan">
        ...
        <div class="panduan-pretest d-flex flex-column align-items-center m-auto w-90">
          ...
          <div class="button-panduan p-3">
            <button class="rounded">Kembali</button>
            <button class="rounded">Mulai kerjakan</button>
          </div>
        </div>
      </div>
    </div>
...
</html><?php /**PATH C:\xampp\htdocs\LARAVEL\tens-dentist\resources\views/user/panduan_postest.blade.php ENDPATH**/ ?>