...
<?php echo app('Illuminate\Foundation\Vite')(['resources/css/style.css', 'resources/js/app.js']); ?>
    ...
    <div class="box-info mb-4 rounded d-flex flex-row flex-wrap p-3 align-items-center gap-3">
        ...
        onclick="window.location='<?php echo e(route('user.info_detail')); ?>'"
        style="cursor: pointer">
            ...
            <div class="card-body-info w-auto h-50">
                <img src="<?php echo e(asset('assets/img/info.png')); ?>" class="w-100 h-100" alt="">
            </div>
...
<?php echo $__env->make('include.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LARAVEL\tens-dentist\resources\views/user/info.blade.php ENDPATH**/ ?>