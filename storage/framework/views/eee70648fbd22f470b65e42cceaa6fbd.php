...
<body class="register-body">
  ...
  <div class="container-fluid container-register d-flex flex-wrap flex-lg-nowrap min-vh-100">
    ...
    <div class="register-form w-100 m-auto">
      <form action="<?php echo e(url('/register_auth')); ?>" id="registerForm" method="post" class="form-control d-flex flex-column gap-2 m-auto p-4">
        <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\LARAVEL\tens-dentist\resources\views/auth/register.blade.php ENDPATH**/ ?>