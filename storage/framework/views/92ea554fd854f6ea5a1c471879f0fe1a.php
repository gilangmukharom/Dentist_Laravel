...
<body>
  ...
  <div class="container-about">
    <div class="img-about w-100">
        <img src="<?php echo e(asset('assets/img/cover-about.png')); ?>" alt="" class="w-100 h-100">
    </div>
    ...
    <div class="about-box">
        <div class="about-content">
            ...
            <div class="about-image">
              <img src="<?php echo e(asset('assets/img/login-animation.png')); ?>" alt="" class="img-about w-25">
              <img src="<?php echo e(asset('assets/img/wave.png')); ?>" alt="" class="about-wave">
            </div>
        </div>
    </div>
  </div>
...
</html><?php /**PATH C:\xampp\htdocs\LARAVEL\tens-dentist\resources\views/layouts/about.blade.php ENDPATH**/ ?>