...
<body>
  ...
  <?php endif; ?>
  <form method="post" action="<?php echo e(route('user.test_pengetahuan.submit')); ?>">
    <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\LARAVEL\tens-dentist\resources\views/user/test_pengetahuan.blade.php ENDPATH**/ ?>