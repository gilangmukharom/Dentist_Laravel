...
<?php $__env->startSection('content'); ?>
    ...
    <div class="content-activity w-100 rounded p-5">
        <div class="form-activity m-auto w-90 position-relative">
            ...
            <form id="dailyForm" action="<?php echo e(route('user.first_daily')); ?>" method="POST" enctype="multipart/form-data"
...
<?php echo $__env->make('include.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LARAVEL\tens-dentist\resources\views/user/activity.blade.php ENDPATH**/ ?>