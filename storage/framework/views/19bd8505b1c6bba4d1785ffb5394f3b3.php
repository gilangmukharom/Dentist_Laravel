    ...
    <div class="login-content d-flex flex-column w-100">
      ...
      <div class="login-box d-flex flex-column m-auto">
        ...
        <div class="login-animation text-center">
          <img src="<?php echo e(asset('assets/img/login-animation.png')); ?>" alt="" class="img-fluid w-50 d-none d-lg-block m-auto">
        </div>
      </div>
    </div>

    <div class="login-form w-100 m-auto">
      <form action="<?php echo e(url('/login_auth')); ?>" method="post" class="form-control d-flex flex-column gap-3 p-4 m-auto">
        <?php echo csrf_field(); ?>
        ...
        <div class="register-buton m-auto">
          <a href="<?php echo e(route('register')); ?>" class="d-flex text-decoration-none">
...
</html><?php /**PATH C:\xampp\htdocs\LARAVEL\tens-dentist\resources\views/auth/login.blade.php ENDPATH**/ ?>