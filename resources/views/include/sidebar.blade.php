            ...
            <ul class="list-unstyled components mb-5">
                ...
                <li>
                    <a href="#" class="dropdown-toggle text-0" type="button" id="dropdownMenuButton1"
                        ...
                        <span class="fa fa-th-list" aria-hidden="true"></span> Daily Activity <span
                ...
                <li>
                    <a href="#" class="dropdown-toggle text-0" type="button" id="dropdownMenuButton1"
                        data-bs-toggle="dropdown" aria-expanded="false">
                        <span class="fa fa-cogs" aria-hidden="true"></span> Teeth Q <span
                            class="fa fa-caret-down"></span>
                    </a>
                    <ul class="dropdown-menu text-bg-secondary" aria-labelledby="dropdownMenuButton1">
                        <li><a class="dropdown-item" href="{{ route('user.panduan_pretest') }}"
                                id="pretest-link">Pretest</a></li>
                        <li><a class="dropdown-item" href="{{ route('user.panduan_postest') }}"
                                id="activity-link">Postest</a></li>
                    </ul>
                </li>
                <li>
                    <a href="#" class="dropdown-toggle text-0" type="button" id="dropdownMenuButton1"
                    ...
                    <ul class="dropdown-menu text-bg-secondary" aria-labelledby="dropdownMenuButton1">
                        <li><a class="dropdown-item" href="{{ route('user.info') }}" id="info-link">Informasi Umum</a>
                        </li>
                        <li><a class="dropdown-item" href="{{ route('user.panduan') }}" id="panduan-link">Panduan
                                Tans</a></li>
                    </ul>
                </li>
                <li>
