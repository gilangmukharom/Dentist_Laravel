...
<body class="register-body">
    ...
    <div class="container-fluid container-register d-flex flex-wrap flex-lg-nowrap min-vh-100">
            ...
            <div class="register-box d-flex flex-column m-5">
                ...
                <div class="register-animation text-left">
                    <p class="text-white text-justify">
                        Silahkan daftar diri anda untuk explorasi lebih luas, Tans Dent merupakan aplikasi menggosok
                        gigi berbasis website dengan model QR dengan media interaktif untuk memfasilitasi keterampilan
                        menggosok gigi anak sekolah dasar
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="register-form w-100 m-auto">
            <form action="{{ url('/register_auth') }}" id="registerForm" method="post"
                class="form-control d-flex flex-column gap-2 m-auto p-4">
                @csrf
                ...
                <input type="submit" id="submitBtn" class="bg-2 w-50 m-auto btn mt-3" data-bs-toggle="modal"
